...
back to list representation, where the elements in the list are plain machine states.
...
would be extracting the work-list algorithm part to an individual function.
