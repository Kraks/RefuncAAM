...
the continuation simply applies its meta-continuation @m@, and the meta-continuation of @aeval@
is the outer meta-continuation @mcontinue@. It would be clear if we inductively think the base case 
