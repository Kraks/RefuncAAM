...
Function @f1@ and @f2@ mutually invoke each other, so the stack will alternately push
...
\begin{itemize}
  ...
  \item If the target closures set of the front-most @NDCont@ is empty (@Nil@ in the code),
    ...
    elements to its front, we resume to the most recent fork point by popping the front-most 
