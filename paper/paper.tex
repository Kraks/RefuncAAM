...
The function @f@ is the delimited continuation captured by the @shift@ operator (formed by the computation), and will be executed after the @choices@'s call-site.
